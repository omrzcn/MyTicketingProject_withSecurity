...
//    @Bean
//    public UserDetailsService userDetailsService (PasswordEncoder encoder){ // this is for encode , spring's user's password
...
//
//
//        return new InMemoryUserDetailsManager(userList);      //  here is if we dont have any DB.
//    }
